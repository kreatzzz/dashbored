    ...
    <div className="grid lg:grid-cols-[minmax(0,1.1fr)_minmax(340px,.9fr)]">
      <div className="relative overflow-hidden p-6 md:p-8 lg:border-r lg:border-border">
        ...
        <div className="relative">
          ...
          <div className="mt-6"><ConnectPortainerDialog /></div>
...
function ConnectPortainerDialog() {
  const [state, action, pending] = useActionState(createPortainerConnection, initialState);

  return <Dialog><DialogTrigger asChild><Button size="sm">Connect Portainer <ArrowRight size={13} /></Button></DialogTrigger><DialogContent className="max-w-md">
